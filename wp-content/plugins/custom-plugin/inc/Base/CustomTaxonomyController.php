...
class CustomTaxonomyController extends BaseController
{
    ...
    public function setSettings()
    {
        $args = array(
            array(
                'option_group' => 'custom_plugin_tax_settings',
                'option_name' => 'custom_plugin_tax',
    ...
    public function storeCustomTaxonomies()
    {
        ...
        $options = get_option( 'custom_plugin_tax' ) ?: array();
