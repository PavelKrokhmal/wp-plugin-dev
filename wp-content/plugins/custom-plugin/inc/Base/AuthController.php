...
class AuthController extends BaseController
{
    public function register()
    {
        ...
        add_action( 'wp_ajax_nopriv_custom_login', array( $this, 'login' ) );
    }
    ...
    public function enqueue()
    {
        ...
        wp_enqueue_script( 'authscript', $this->plugin_url . 'assets/auth.min.js' );
    }
    ...
    {
        check_ajax_referer('ajax-login-nonce', 'custom_auth');
